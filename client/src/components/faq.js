        ...
        return (
          ...
          <Accordion fluid styled>
            ...
            <Accordion.Content active={activeIndex === 0}>
              ...
              <p>
              ዋጋ በ ኪ/ሜ 14 ብር ነው ፡ ሲስተሙ አስቀድሞ በአጨር መንገድ መርጦ ዋጋውን አስልቶ ያሳያል። ከ 3 ኪ/ሜ በታች 
              ያሉ ጉዞዎች ግን 50 ብር ነው። 
              </p>
            </Accordion.Content>
            ...
            <Accordion.Content active={activeIndex === 1}>
              <p>
                ...
                ተሳፍሪው የሚሄድበትን ቦታ nileride.com ድረገጽ በሚያሳውቅበት ወቅት ፡ ሲስተሙ 
                አስቀድሞ መንገዱ በ ኪ/ሜ  ምን ያህል እንደሆነ ልክቶ በ ኪ/ሜ 14 ብር አባዝቶ ዋጋውን ለተሳፍሪው ይስውቀዋል።
                ተሳፍሪው ዋጋን አውቆ ውሳኒውን ከተቀበለ ሲስተሙ አጠገቡ ላለ ሹፊር ጥያቄውን ይልክለታል። ሹፊሩም የመጣውን 
            ...
            <Accordion.Content active={activeIndex === 7}>
              ...
              መሆን አለበት ፡ ካልሆነ አንደገና ይጫኑት። የስልኮን GPS/location service ማብራት በመቀጠል share location ለሚለው ጥያቄ allow ማለት። 
              "ወዴት መሄድ ይፈልጋሉ ?” የሚለው የቦታ መፈለግያ ሳጥን ውስጥ መሄድ የፈልጉበትን ቦታ ስም ፤ በአቅራብያው የሚገኝ የተዋቀ ስም 
              ወይም ተቀራራቢ የሚታውቅ ስም በአማርኛ ወይም በኢንግሊዘኛ መጻፉ። የቦታውን ስም የያዘ ዝርዝር ይመጣል ፡ ከዝርዝሩ ውስጥ የመጀመርያውን ይምረጡ ።
              </p>
            ...
            <Accordion.Content active={activeIndex === 2}>
              ...
              <p> 
               ...
               <p>
                  ...
                  ስልኮ screen lock መሆን ይችላል ፡ ሲስተሙ ሥራ ሲመጣ ድምጽ ያስሞታል። 
               </p> 

               <p>
               ቢችሉ online ይሁኑ ፡ ካልቻሉ ግን ፡ የግድ ቦታ ሲቀይሩ አንድ ግዜ ወድ ሲስተሙ መግባት እና የመኪና ምልክቱ በማፑ መቀየሩን ካረጋገጡ በኅላ ፡ 
               offline መሆን ይችላሉ ፡ ሲስተሙ ሥራ ሲመጣ አጠገቦ ላለ ተሳፍሪ ስልኮን ያሳያል ፡ ተሳፋሪው ይደውልሎታል እባኮትን በፍጥነት ወድ ሲስተሙ ገብተው ጉዞውን ይቀጥሉ።
               </p>
               <p>
            ...
            <Accordion.Content active={activeIndex === 9}>
              <p>            
                ...
                ሁለተኛ - ሲስተሙ አስልቶ የሚቀርበውን በ ኪ/ሜ 14 ብር ዋጋ መስማማት ። የተሳፋሪ አስተያየት ቅድምያ ይኖረዋል። 
              </p>
            </Accordion.Content>
