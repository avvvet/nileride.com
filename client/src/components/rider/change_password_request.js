...
import $ from 'jquery';
import UserChangePasswordVarify from './change_password_varify';
         ...
         $.ajax({ 
             ...
             success: function(data, textStatus, jqXHR) {
              ...
              if(data.rply === 1){
                ...
                render(<UserChangePasswordVarify></UserChangePasswordVarify>,document.getElementById('div-change-pass'));
                this.setState({
                    mobile_2: '',
                    errors: []
                });
